...
export default function ClassicProfessionalPortfolio({
  ...
  const accent = sanitizeHexColor(mainColor, "#1d4ed8");
  const bg = sanitizeHexColor(backgroundColor, "#f8fafc");
      ...
      <div className={styles.root} style={rootStyle}>
        <div className={styles.shell}>
          <section className={styles.hero}>
            <p className={styles.bodyText}>No resume data found. Upload your resume to generate a template preview.</p>
          </section>
        </div>
      </div>
    );
    ...
    <div className={`${styles.root} ${darkMode ? styles.darkMode : ""}`} style={rootStyle} ref={rootRef}>
      ...
      <div className={styles.shell}>
        ...
        <HeroSection
          ...
          location={personal.contact_info.address}
