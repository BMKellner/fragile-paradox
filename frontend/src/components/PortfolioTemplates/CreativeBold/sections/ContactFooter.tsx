    ...
    <>
      <section id="contact" className={styles.section} data-reveal>
        ...
        <article className={styles.contactCard}>
          <p>Open to impactful product work, consulting, and technical leadership opportunities.</p>
      ...
      <footer className={styles.footer}>© {new Date().getFullYear()} {fullName}. Built to stand out with substance.</footer>
    </>
  );
}
