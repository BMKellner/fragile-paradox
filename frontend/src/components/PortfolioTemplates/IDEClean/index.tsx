...
import styles from "./IDEClean.module.css";
import {
  SectionType,
  sectionTitle,
...
export default function IDECleanPortfolio({
  personalInformation,
  overviewData,
  projects,
  experience,
  ...
  const accent = sanitizeHexColor(resolvedConfig.theme.primaryColor, "#22d3ee");
  const bg = sanitizeHexColor(resolvedConfig.theme.backgroundColor, "#0b1221");
      ...
      case SectionType.Hero: {
        ...
        return (
          <section key={section.id} id={section.id} className={styles.hero} data-reveal>
            ...
            <h2>{content.careerName || "Systems Engineer"}</h2>
            <p className={styles.heroSummary}>{content.summary || "Shipping robust interfaces with clean architecture, developer empathy, and production discipline."}</p>
      ...
      <div className={styles.layout}>
        <aside className={styles.rail}>
          <div className={styles.railTop}>
            ...
            <p>{heroContent.careerName || "Systems Engineer"}</p>
          </div>
