...
import styles from "./BoldBrand.module.css";
import {
  SectionType,
  sectionTitle,
...
export default function BoldBrandPortfolio({
  personalInformation,
  overviewData,
  projects,
  experience,
  ...
  const accent = sanitizeHexColor(resolvedConfig.theme.primaryColor, "#ff4d6d");
  const bg = sanitizeHexColor(resolvedConfig.theme.backgroundColor, "#0b0b14");
  ...
  const heroContent =
    ...
    ({
      ...
      eyebrow: "Portfolio",
      fullName: "Your Name",
      careerName: "Brand-Driven Builder",
      summary: "",
      primaryCtaLabel: "Launch Collaboration",
      ...
      case SectionType.Hero: {
        ...
        return (
          <section key={section.id} id={section.id} className={styles.hero} data-reveal>
            ...
            <h1>
              <span className={styles.heroName}>{content.fullName || "Your Name"}</span>
            </h1>
            <h2>{content.careerName || "Brand-Driven Builder"}</h2>
            <p className={styles.heroSummary}>{content.summary || "Creating brand-forward digital products with bold storytelling and production-grade execution."}</p>
            ...
            <div className={styles.heroActions}>
              ...
              >
                {content.primaryCtaLabel || "Launch Collaboration"}
              </button>
      ...
      <div className={styles.layout}>
        <aside className={styles.rail}>
          <div className={styles.railTop}>
            ...
            <p>{heroContent.careerName || "Brand-Driven Builder"}</p>
          </div>
